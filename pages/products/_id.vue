      ...
      <div class="whats-included-container">
        <div class="included-container">
          ...
          <p>
            ...
            dignissimos, minus laborum quo culpa aperiam totam impedit dolorum
            assumenda sed placeat. Dolore, recusandae? Sequi, voluptatum
            placeat! Possimus eius amet nisi.
          </p>
        </div>
        <div class="included-container">
          <h6>Clean & Tidy</h6>
...
export default {
  ...
  components: { PageNotFound, RentModal },
};
</script>
